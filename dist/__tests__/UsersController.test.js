...
describe('UsersController', function () {
    ...
    var user;
    var userToken;
    test('should create new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    expect(user.id && user.passwordHash && user.salt && user.created_at).toBeTruthy();
                    return [2 /*return*/];
            }
        });
    }); });
    test('should throw an error if username already in use', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(response.body.error).toEqual('user with the username already exists');
                    return [2 /*return*/];
            }
        });
    }); });
    test('should login the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
    ...
    test('should return all access tokens for the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, tokens;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
    ...
    test('should delete the access token for the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var deleteResponse, allTokensResponse, allTokens;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
                        .delete("/v1/access_tokens/".concat(userToken))
                        .auth(USER_CREDENTIALS.username, USER_CREDENTIALS.password)];
                case 1:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app)
                            ...
                            .auth(USER_CREDENTIALS.username, USER_CREDENTIALS.password)];
                case 2:
                    allTokensResponse = _a.sent();
                    allTokens = allTokensResponse.body;
                    expect(deleteResponse.status).toEqual(200);
                    expect(allTokens.some(function (tokenObject) {
                        return tokenObject.accessToken === userToken;
                    })).toBeFalsy();
                    return [2 /*return*/];
            }
        });
