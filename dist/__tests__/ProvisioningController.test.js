...
describe('ProvisioningController', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var USER_CREDENTIALS, _a, tokenResponse;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    USER_CREDENTIALS = TestData_1.default.getUser();
                    DEVICE_ID = TestData_1.default.getID();
                    TEST_PUBLIC_KEY = TestData_1.default.getPublicKey();
                    sinon_1.default
                        ...
                        return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_b) {
                                ...
                                return [2 /*return*/, { error: new Error() }];
                            });
                        });
                    });
    ...
    test('provision and add keys for a device.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    test('should throw an error if public key has wrong format', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
    ...
    test('should throw an error if public key is not provided', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app)
...
//# sourceMappingURL=ProvisioningController.test.js.map