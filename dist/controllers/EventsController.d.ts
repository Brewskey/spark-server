...
declare class EventsController extends Controller {
    ...
    getEvents(eventNamePrefix?: string | null): Promise<void>;
    getMyEvents(eventNamePrefix?: string | null): Promise<void>;
