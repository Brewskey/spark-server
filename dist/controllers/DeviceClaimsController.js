...
var DeviceClaimsController = /** @class */ (function (_super) {
    __extends(DeviceClaimsController, _super);
    ...
    DeviceClaimsController.prototype.createClaimCode = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        deviceIDs = devices.map(function (device) {
                            return (0, nullthrows_1.default)(device.deviceID);
                        });
                        return [2 /*return*/, this.ok({ claim_code: claimCode, device_ids: deviceIDs })];
                }
            });
        });
    };
    __decorate([
        ...
        (0, route_1.default)('/v1/device_claims')
    ], DeviceClaimsController.prototype, "createClaimCode", null);
    return DeviceClaimsController;
}(Controller_1.default));
exports.default = DeviceClaimsController;
//# sourceMappingURL=DeviceClaimsController.js.map